...
export const After = () => {
    return (
        ...
        <div className="after-block">
            <h3 className="after-block__left-title">После выпуска</h3>
            <div className="after-block-content">
                <div className="after-block__left white-round">
                    ...
                    <div className="after-block__left-instruments">
                        ...
                        <div className="after-block__left-imgs">
                            <img className="after-block__left-img" src="./img/bank.jpg"></img>
                            <img className="after-block__left-img" src="./img/nind.jpg"></img>
                            <img className="after-block__left-img" src="./img/figma.jpg"></img>
                            <img className="after-block__left-img" src="./img/react.jpg"></img>
                            <img className="after-block__left-img" src="./img/tilda.jpg"></img>
                            <img className="after-block__left-img" src="./img/wind.jpg"></img>
                        </div>
                    </div>
                    <div className="after-block__left-text-block">
                ...
                <div className="after-block__right">
                    ...
                    <div className="after-block__right-imgs">
                        <img className="after-block__right-img" src="./img/after1.jpg"></img>
                        <img className="after-block__right-img" src="./img/after2.jpg"></img>
                        <img className="after-block__right-img" src="./img/after3.jpg"></img>
                        <img className="after-block__right-img" src="./img/after4.jpg"></img>
                    </div>
                    <div className="after-block__right-info">
                        <div className="after-block__right-info-left white-round">
                            ...
                            <img className="after-block__right-info-img" src="./img/after-bg-1.jpg"></img>
                        </div>
                        <div className="after-block__right-info-right white-round">
                            ...
                            <img className="after-block__right-info-img" src="./img/after-bg-2.jpg"></img>
                        </div>
                    </div>
                </div>
            </div>
